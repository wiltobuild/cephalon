# Warframe and Weapon Build Guides — Sample Set

The finished, reviewed guides so far: Warframes 1 through 35. This file is a stable
sample of the house style and depth while the full set is still being written; the
complete collection lives in `build-guides.md`.

Each build is written up in full: what the build does, how the pieces hold
together, how to actually pilot it, what you can move around, and where it stops
working.
