...
export const navigation: NavItem[] = [
  ...
  { label: "Tools", href: "/tools", icon: SlidersHorizontal, children: [child("Damage Calculator", "/tools/weapon-builder", Calculator), child("Enemy Simulator", "/tools/enemy-simulator", Target), child("Riven Analyzer", "/tools/riven-analyzer", ScrollText)] },
